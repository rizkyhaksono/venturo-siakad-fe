      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="profile-section">
            ...
            <div class="space-y-4">
              <div class="flex flex-col">
                <label class="text-sm text-gray-600 dark:text-gray-300">ID</label>
                <input type="text"
              ...
              <div class="flex flex-col">
                <label class="text-sm text-gray-600 dark:text-gray-300">Phone</label>
                <input type="tel"
                  class="mt-1 p-2 border rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-gray-200 dark:border-gray-600"
          ...
          <div class="profile-section">
            ...
            <div class="space-y-4">
              <div class="flex flex-col">
                <label class="text-sm text-gray-600 dark:text-gray-300">Username</label>
                <input type="text"
                  class="mt-1 p-2 border rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-gray-200 dark:border-gray-600"
                  :value="authStore.userLogin.name" />
              </div>
              <div class="flex flex-col">
                <label class="text-sm text-gray-600 dark:text-gray-300">User Roles ID</label>
                <input type="text"
                  class="mt-1 p-2 border rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-gray-200 dark:border-gray-600"
