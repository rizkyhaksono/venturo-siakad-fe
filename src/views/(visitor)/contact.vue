...
const contactInfo = ref([
  {
    title: 'Email',
    value: 'mrizkyhaksono@gmail.com',
    icon: 'envelope',
    link: 'mailto:mrizkyhaksono@gmail.com'
  },
  {
    title: 'Telepon',
    value: '+62 11 1111111',
  ...
  {
    title: 'Alamat',
    value: 'Jl. Rinjani No.26, Oro-oro Dowo, Kec. Klojen, Kota Malang, Jawa Timur 65112',
    icon: 'map-pin',
    link: 'https://maps.app.goo.gl/N3KNB6JLFHc9AFNf9'
  }
]);
    ...
    <section class="py-16 bg-blue-600 dark:bg-blue-700 text-white">
      <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <a href="https://calendly.com/siakad/demo" target="_blank"
            ...
            Jadwalkan Demo Melalui Meeting
          </a>
        </div>
      </div>
    </section>
