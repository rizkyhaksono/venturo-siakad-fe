        ...
        <div class="mt-4 w-full overflow-hidden rounded-lg border border-gray-200">
          <table class="w-full">
            ...
            <tbody class="group text-sm text-gray-800 dark:text-white">
              <template v-if="classStore.roles && classStore.roles.length > 0">
                <tr class="border-b border-gray-200 last:border-0" v-for="row in classStore.roles" :key="row.id">
                  <td class="p-3">
